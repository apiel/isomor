...
function transformClass(root, srcFilePath, wsReg, path, pkgName, withTypes, noDecorator) {
        ...
        body.forEach((node, index) => {
            if (node.type === 'ClassMethod') {
                ...
                if (name === 'constructor') {
                    ...
                    root.declaration.body.body[index] = code_1.getCodeMethod(wsReg, path, pkgName, name, className, withTypes);
                }
            }
